 ...
 * is the implementation of a method to decide if an object is part of the result set
...
public abstract class Evaluator {
     ...
     * @return Return true if the object must be part of the result set or false in the
     * other ways.
     */
